...
#print(normalize("fake_obama_frames", "obama_testing"))

with open("/Users/sofielysenko/Downloads/PennAppsXX-master/Extension/Result.txt", "a") as f:
    f.write(normalize("fake_obama_frames", "obama_testing"))
